...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-stone-50 md:max-w-2xl lg:max-w-4xl mx-auto">
      ...
      </header><button onClick={() => window.location.href = "/login"} className="fixed top-4 right-4 z-50 bg-red-500 text-white p-2 rounded-full shadow-lg"><LogOut className="w-4 h-4" /></button>
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <button onClick={() => router.push('/reportes')} className="bg-rose-50 border border-rose-200 rounded-2xl p-5 text-left hover:bg-rose-100">
            ...
            <span className="text-xs text-stone-500">Estadísticas y gráficos</span>
          </button>
