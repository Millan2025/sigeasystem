...
import { ShoppingCart, DollarSign, Package, Users, Truck, BarChart3, Share2 } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-stone-50">
      ...
      <div className="p-4 space-y-4">
        <div className="bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl p-6 text-white cursor-pointer" onClick={() => router.push('/admin')}>
          <p className="text-emerald-100 text-sm">VENTAS DE HOY</p>
          <p className="text-4xl font-bold mt-1">,000</p>
        ...
        <div className="grid grid-cols-2 gap-3">
          <button onClick={() => router.push('/pos')} className="bg-emerald-50 border border-emerald-200 rounded-2xl p-5 text-left hover:bg-emerald-100">
            ...
            <span className="text-xs text-stone-500">POS Tactil</span>
          </button>
          ...
          <button onClick={() => router.push('/admin')} className="bg-amber-50 border border-amber-200 rounded-2xl p-5 text-left hover:bg-amber-100">
          ...
          <button onClick={() => router.push('/admin')} className="bg-purple-50 border border-purple-200 rounded-2xl p-5 text-left hover:bg-purple-100">
          ...
          <button onClick={() => router.push('/admin')} className="bg-sky-50 border border-sky-200 rounded-2xl p-5 text-left hover:bg-sky-100">
          ...
          <button onClick={() => router.push('/admin')} className="bg-rose-50 border border-rose-200 rounded-2xl p-5 text-left hover:bg-rose-100">
            <BarChart3 className="w-7 h-7 text-rose-600 mb-2" />
            <span className="font-semibold text-stone-800 block">Reportes</span>
            <span className="text-xs text-stone-500">Estadisticas y finanzas</span>
          </button>
        </div>
      </div>
    </div>
