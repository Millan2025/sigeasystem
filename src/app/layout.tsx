...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="es"><head><meta name="apple-mobile-web-app-capable" content="yes" /><meta name="apple-mobile-web-app-status-bar-style" content="black-translucent" /><meta name="apple-mobile-web-app-title" content="SIGEA" /><link rel="apple-touch-icon" href="/logoNegro-sigea.png" /><link rel="icon" type="image/png" href="/logoNegro-sigea.png" /></head><head><link rel="icon" href="/logoNegro-sigea.png" /><link rel="apple-touch-icon" href="/logoNegro-sigea.png" /></head>
