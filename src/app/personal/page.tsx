...
const empleadosDemo = [
  { id: '1', nombre: 'Carlos GÃ³mez', cargo: 'Cajero', salario: 1423500, horario: '06:00-14:00', asistencias: 22, horasExtras: 4, estado: 'activo' },
  { id: '2', nombre: 'MarÃ­a LÃ³pez', cargo: 'Panadera', salario: 1500000, horario: '02:00-10:00', asistencias: 20, horasExtras: 8, estado: 'activo' },
  { id: '3', nombre: 'Juan PÃ©rez', cargo: 'Repartidor', salario: 1300000, horario: '08:00-16:00', asistencias: 21, horasExtras: 3, estado: 'activo' },
  { id: '4', nombre: 'Ana Ruiz', cargo: 'Vendedora', salario: 1300000, horario: '10:00-18:00', asistencias: 18, horasExtras: 0, estado: 'ausente' },
]

const registrosHoy = [
  { empleado: 'Carlos GÃ³mez', tipo: 'entrada', hora: '05:58', metodo: 'app' },
  { empleado: 'MarÃ­a LÃ³pez', tipo: 'entrada', hora: '01:55', metodo: 'app' },
  { empleado: 'Juan PÃ©rez', tipo: 'entrada', hora: '07:50', metodo: 'app' },
  { empleado: 'Carlos GÃ³mez', tipo: 'salida_descanso', hora: '09:00', metodo: 'app' },
  { empleado: 'Carlos GÃ³mez', tipo: 'entrada_descanso', hora: '09:30', metodo: 'app' },
]
    ...
    <div className="min-h-screen bg-stone-50 max-w-lg mx-auto">
      <header className="bg-gradient-to-r from-stone-800 to-stone-700 text-white p-5">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h1 className="text-xl font-bold">ðŸ‘¥ Personal</h1>
            <p className="text-stone-400 text-sm">PanaderÃ­a DoÃ±a Rosa</p>
          </div>
        </div>
        <div className="flex gap-1 bg-stone-700 rounded-xl p-1">
          {[
            ...
            { id: 'nomina' as const, label: 'NÃ³mina', icon: DollarSign },
          ].map(t => (
            ...
            {empleadosDemo.map(e => (
              <div key={e.id} className="bg-white rounded-2xl p-4 border border-stone-200">
                <div className="flex justify-between items-start mb-3">
                  <div>
                    <h3 className="font-semibold text-stone-800">{e.nombre}</h3>`n            <button className="text-xs bg-stone-100 px-3 py-1 rounded-lg hover:bg-stone-200">✏️ Editar</button>
                    <p className="text-sm text-stone-400">{e.cargo} â€¢ {e.horario}</p>
                  </div>
                ...
                <div className="grid grid-cols-3 gap-2 text-center text-xs">
                  ...
                  <div className="bg-stone-50 rounded-xl p-2">
                    ...
                    <p className="font-bold text-stone-800">{e.asistencias} dÃ­as</p>
                  </div>
                  <div className="bg-stone-50 rounded-xl p-2">
        ...
        {tab === 'nomina' && (
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-white rounded-2xl p-4 border border-stone-200">
                <p className="text-xs text-stone-400">NÃ³mina del mes</p>
