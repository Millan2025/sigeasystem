    ...
    <div className="min-h-screen bg-stone-50 md:max-w-2xl lg:max-w-4xl mx-auto">
      <header className="bg-gradient-to-r from-stone-800 to-stone-700 text-white p-5">
        <div className="flex items-center gap-3">
          <Link href={typeof window !== "undefined" && !window.location.pathname.startsWith("/demo/") ? `/${window.location.pathname.split("/")[1]}` : `/demo/${negocioSlug}`} className="p-2 hover:bg-white/10 rounded-xl transition">
